...
static void source_set_volume_cb(pa_source *s) {
    ...
    if (u->transport->set_microphone_volume) {
    ...
    if (!u->transport->set_microphone_volume
        || !u->transport->can_attenuate_source_volume
        || !u->transport->can_attenuate_source_volume(u->transport))
...
static void sink_set_volume_cb(pa_sink *s) {
    ...
    if (u->transport->set_speaker_volume) {
    ...
    if (!u->transport->set_speaker_volume
        || !u->transport->can_attenuate_sink_volume
        || !u->transport->can_attenuate_sink_volume(u->transport))
        s->soft_volume = s->real_volume;
}
